...
Pseudocode:
- first send a Message in a circle (P0 to P1, P1 to P2, ...,
- then let P0 broadcast to every process that every process reached the barrier
...
1. Heavily based on the University of Saskatchewan's CMPT851: [slides for MPI, OpenMP and more][CMPT851-slides].
