...
- try to build a simple scene yourself (follow a ML_Agents tutorial)
- redesign the agent
- build a scene where the goal is to jump over a wall by using different building blocks

-> cool jump and run video idea: it has to reach the other side (using different tools/ platforms etc.) and the middle part is lava

- make it achievable through some imitation learning (included in the ML_Agents package)

- follow [this tutorial by Code Monkey](https://www.youtube.com/watch?v=zPFU30tbyKs&list=PLRX5NE3BRgOYqTPd4jNaO7RdvuilCIhfz&index=2)

- red vs. blue agent

### Unity: View navigation

- select an object and press "F" instead to jump to different scroll distances



### Recorder

- [Docs](https://docs.unity3d.com/Packages/com.unity.recorder@3.0/manual/RecordingRecorderWindow.html)
- open the recorder window via window/general/recorder/recorder_window

- use the following settings:
"Image Sequence" recorder with "Textrue Sampling" as source, use the "ActiveCamera" and save to the "Project" folder.


### Cute character design

- use stable diffusion to generate some concept art
...
- learn to beat SquidGame
- beat an obstacle course with lava beneath (from one to the other platform)
...
5. Golf
6. Hockey
7. Volleyball (https://towardsdatascience.com/ultimate-volleyball-a-3d-volleyball-environment-built-using-unity-ml-agents-c9d3213f3064)
8. Rugby
9. Cricket
10. Snowboard, Ski
11. Skateboard
...
- [Fiver: ninufasat (3d low poly island)](https://www.fiverr.com/ninufsat/model-3d-low-poly-game-ready-assets?context_referrer=subcategory_listing&source=category_tree&ref_ctx_id=d33f0239ba05b129e30cb0232f999a16&pckg_id=1&pos=3&context_type=rating&funnel=d33f0239ba05b129e30cb0232f999a16&imp_id=7874b68b-4224-4d2e-b7dc-f9245a380690)
- [Fiver: level/ environment design (desert, treeland)](https://www.fiverr.com/lovrobubanic/do-level-design-and-optimization-for-your-unity-game?context_referrer=search_gigs&source=top-bar&ref_ctx_id=0b764c1c1d326d22e381d7fe39328d95&pckg_id=1&pos=3&ad_key=6d880692-6446-479b-b2b7-ebac8a229948&context_type=auto&funnel=0b764c1c1d326d22e381d7fe39328d95&imp_id=fb604496-71cd-4b24-82a7-865e3a70bcc8)
...
<div class="table-wrap">
    <table class="table">
        <tr>
            ...
            <td><strong>Approximated revenue ($)</strong></td>
